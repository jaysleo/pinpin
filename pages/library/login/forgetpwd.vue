		...
		<view class="loginwrap">
			<block v-if="step==1">
				<view class="welcome u-flex-col">
					<u-image :lazy-load="false" :fade="false" src="/static/images/index/tip_phone.png" width="222" height="52"></u-image>
			...
			<block v-if="step==2">
				<view class="welcome u-flex-col">
					<u-image :lazy-load="false" :fade="false" src="/static/images/index/tip_code.png" width="222" height="52"></u-image>
	...
	export default{
		...
		methods:{
			...
			nextStep(){
				...
				let iscode = this.$u.test.code(this.form.code,6);
				if(num==1){
					if(!isphone){
