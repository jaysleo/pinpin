<template>
	<view class="container u-rela">
		...
		<view class="loginwrap">
			<view class="welcome">
				<u-image :lazy-load="false" :fade="false" src="/static/images/index/welcome.png" width="260" height="104"></u-image>
			</view>
			<view class="loginbox">
	...
	export default{
		...
		methods:{
			...
			onSubmit(){
				...
				this.$http.register(prams).then((res)=>{
					this.$u.toast(res.msg);
					setTimeout(()=>{
						uni.reLaunch({url:"/pages/library/login/index"});
					},800);
				})
			}
		},
